...
export default {
  ...
  methods: {
    /**
     * @description 過濾選項 這個方法在每次輸入框的值發生變化時會觸發
     */
    ...
    /**
     * @description 指定的數據源中根據指定的查詢字符串過濾數據
     * @param {Object} pool 需要過濾的數據
    ...
    /**
     * @description 接收用戶在列表中選擇項目的事件
     */
    handleResultsGroupItemClick (path) {
      // 如果用戶選擇的就是當前頁面 就直接關閉搜索面板
